...
"[project]/apps/web/components/ui/card-grid.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CardGrid({ courseId, viewAll }) {
    _s();
    const { data: documents, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$api$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDocuments"])(courseId);
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CardGrid, "XOqUhCsiGA1genM1s2SWkGBapS4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$api$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDocuments"]
    ];
});
_c = CardGrid;
var _c;
...
"[project]/apps/web/app/(main)/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Home() {
    _s();
    const { data: selectedCourse, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$api$2f$courses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelectedCourse"])();
    ...
    const handleNewChat = async (messageContent)=>{
        ...
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].info('Creating real chat immediately');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].info('Created real chat:', {
                chatId: newChat.id,
                title: newChat.title
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].info('Navigating to real chat:', {
                chatId: newChat.id
            });
...
//# sourceMappingURL=apps_web_c2fa48b9._.js.map
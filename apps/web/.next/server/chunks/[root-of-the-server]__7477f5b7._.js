...
"[project]/apps/web/.next-internal/server/app/api/chats/[chatId]/select/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/apps/web/app/api/chats/[chatId]/select/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
      ...
      `).eq('id', chatId).eq('user_id', auth.userId).eq('courses.school_id', auth.selectedSchool).single();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7477f5b7._.js.map
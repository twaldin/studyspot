...
"[project]/apps/web/features/chat/services/streaming-manager.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ class StreamingManagerService {
   ...
   */ async executeStreaming(messageContent, conversationHistory, courseId, context, signal) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$chat$2d$streaming$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatStreamingService"].sendMessage(messageContent, conversationHistory, courseId);
        // Check if cancelled
        if (signal.aborted) {
            throw new Error('Streaming cancelled');
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$chat$2d$streaming$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatStreamingService"].processStreamingResponse(response, context);
    }
    /**
   ...
   */ stopAllStreams() {
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].info('Stopping all active streams');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$streaming$2d$manager$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/features/chat/services/streaming-manager.service.ts [app-ssr] (ecmascript)");
...
function ChatPageContent() {
    ...
    const { setStreamingStatus, updateStreamingMessage, getStreamingMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$PendingChatContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStreamingChats"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (chat && chat.chats && messages.length === 0) {
            ...
            const isActivelyStreaming = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$streaming$2d$manager$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamingManager"].isStreaming(chatId);
            if (isActivelyStreaming) {
                // Update the streaming context with current UI state
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$streaming$2d$manager$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamingManager"].updateStreamContext(chatId, {
                    setMessages,
                    setIsReplying,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (initialMessage && selectedCourse && chat && chatId && !__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$streaming$2d$manager$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamingManager"].isStreaming(chatId)) {
            ...
            if (shouldStartStreaming) {
                ...
                const startStreaming = async ()=>{
                    try {
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$streaming$2d$manager$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamingManager"].startStreaming(chatId, initialMessage, [], selectedCourse.id, {
                            setMessages,
    ...
    const handleFormSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (values)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$streaming$2d$manager$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["streamingManager"].startStreaming(chatId, values.message, conversationHistory, selectedCourse.id, {
                setMessages,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a221429f._.js.map
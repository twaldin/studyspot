...
"[project]/apps/web/.next-internal/server/app/api/schools/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
class SupabaseService {
   ...
   */ getSupabaseUrl() {
        ...
        if (!url) {
            throw __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$core$2f$error$2d$response$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorService"].createError("server_error", "NEXT_PUBLIC_SUPABASE_URL environment variable is not set");
        }
        return url;
    }
    /**
   ...
   */ getSupabaseAnonKey() {
        ...
        if (!key) {
            throw __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$core$2f$error$2d$response$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorService"].createError("server_error", "NEXT_PUBLIC_SUPABASE_ANON_KEY environment variable is not set");
        }
        return key;
    }
    /**
...
"[project]/apps/web/app/api/schools/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
            ...
            schoolsWithDomain: schools?.filter((s)=>s.domain)?.length,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75fee7bb._.js.map
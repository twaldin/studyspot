...
"[project]/apps/web/.next-internal/server/app/api/chats/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/apps/web/features/chat/services/chat.service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ChatService {
   ...
   */ async getChats(userId, selectedSchool) {
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
                userId,
                selectedSchool
            }, '[ChatService] Fetching chats for user');
            const supabase = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$database$2f$supabase$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseService"].createAuthenticatedClient();
        ...
        `).eq('user_id', userId).eq('courses.school_id', selectedSchool).order('created_at', {
                ascending: false
            });
            if (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                    ...
                    userId,
                    selectedSchool
                }, '[ChatService] Supabase error fetching chats');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                ...
                userId,
                selectedSchool
            }, '[ChatService] Failed to fetch chats');
            throw new Error(error.message || 'Failed to fetch chats');
        }
    }
    /**
   * Get a specific chat by ID with school verification
   */ async getChat(chatId, userId, selectedSchool) {
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
                chatId,
                userId,
                selectedSchool
            }, '[ChatService] Fetching chat details');
            const supabase = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$database$2f$supabase$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseService"].createAuthenticatedClient();
        ...
        `).eq('id', chatId).eq('user_id', userId).eq('courses.school_id', selectedSchool).single();
            if (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                    error,
                    chatId,
                    userId
                }, '[ChatService] Supabase error fetching chat');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
                chatId,
                userId
            }, '[ChatService] Successfully fetched chat');
            return {
                chat: cleanedChat
            };
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                ...
                chatId,
                userId
            }, '[ChatService] Failed to fetch chat');
            throw new Error(error.message || 'Failed to fetch chat');
        }
    }
    /**
   * Create a new chat
   */ async createChat(data, userId, courseId) {
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
                userId,
                courseId,
                hasTitle: !!data.title
            }, '[ChatService] Creating new chat');
            const supabase = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$database$2f$supabase$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseService"].createAuthenticatedClient();
            ...
            const { data: createdChat, error } = await supabase.from('chats').insert(newChatData).select().single();
            if (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                    error,
                    userId,
                    courseId
                }, '[ChatService] Supabase error creating chat');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
                ...
                title: chatTitle,
                userId
            }, '[ChatService] Chat created successfully');
            return {
                chat: createdChat
            };
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                ...
                userId,
                courseId
            }, '[ChatService] Failed to create chat');
        ...
        try {
            ...
            if (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                    ...
                    chatId,
                    userId
                }, '[ChatService] Supabase error updating chat');
                throw new Error('Failed to update chat in database');
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info({
                chatId,
                userId
            }, '[ChatService] Chat updated successfully');
            return {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                ...
                chatId,
                userId
            }, '[ChatService] Failed to update chat');
        ...
        try {
            ...
            if (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                    ...
                    chatId,
                    userId
                }, '[ChatService] Supabase error deleting chat');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                ...
                chatId,
                userId
            }, '[ChatService] Failed to delete chat');
            throw new Error(error.message || 'Failed to delete chat');
        }
    }
    /**
   * Get user's selected course
   */ async getUserSelectedCourse(userId) {
        try {
            const selectedCourseId = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$auth$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authService"].getSelectedCourse(userId);
            return selectedCourseId || null;
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                error,
                userId
            }, '[ChatService] Failed to get selected course for user');
            return null;
        }
    }
    /**
   ...
   */ async generateMeaningfulTitle(messages) {
        try {
            ...
            if (this.isOnlyGenericGreeting(firstUserMessage.content)) {
                const secondUserMessage = messages.find((msg)=>msg.role === 'user' && msg !== firstUserMessage);
                if (secondUserMessage) {
                    return this.generateGeminiTitle({
            ...
            }, '[ChatService] Failed to generate meaningful title, using fallback');
            return 'New Chat';
        }
    }
    /**
   * Generate a concise title using Gemini AI
   */ async generateGeminiTitle(params) {
        try {
            const { content, fallbackTitle } = params;
            // Initialize Gemini with API key
            const apiKey = process.env.GOOGLE_API_KEY;
            if (!apiKey) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('[ChatService] Missing GOOGLE_API_KEY environment variable');
            ...
            const title = String(responseText).trim().replace(/["']/g, '') // Remove quotes
            .replace(/^Title:?\s*/i, '') // Remove "Title:" prefix if present
            .substring(0, 50); // Enforce max length as safety
            // Don't accept generic titles from Gemini
            if (title.toLowerCase().includes('greeting') || title.toLowerCase().includes('simple') || title.toLowerCase().includes('new message')) {
            ...
            if (title) {
                ...
                }, '[ChatService] Generated chat title');
                return title;
            }
            ...
            const fallbackTitle = params.fallbackTitle || params.content.split('\n')[0].trim().replace(/[?!.]$/, '').substring(0, 50);
            return fallbackTitle || 'New Chat';
        }
    }
    /**
   * Check if a message is only a generic greeting
   */ isOnlyGenericGreeting(message) {
        const greetings = [
            'hello',
            'hi',
            'hey',
        ...
        return greetings.some((greeting)=>cleanMessage === greeting || cleanMessage === greeting + '.' || cleanMessage === greeting + '!' || cleanMessage === greeting + '?');
    }
}
const chatService = ChatService.getInstance();
}}),
"[project]/apps/web/app/api/chats/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@15.3.4_@babel+core@7.28.0_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$auth$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/services/auth/auth.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$chat$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/features/chat/services/chat.service.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        const auth = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$auth$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authService"].validateAuthWithSchool();
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$chat$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chatService"].getChats(auth.userId, auth.selectedSchool);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            chats: result.chats
        });
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        // Get user's selected course
        const selectedCourseId = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$chat$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chatService"].getUserSelectedCourse(auth.userId);
        if (!selectedCourseId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$features$2f$chat$2f$services$2f$chat$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chatService"].createChat({
            title,
            initialMessages
        }, auth.userId, selectedCourseId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(result.chat, {
            status: 201
        });
    } catch (error) {
        const message = error instanceof Error ? error.message : 'An unknown error occurred';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b199d98c._.js.map
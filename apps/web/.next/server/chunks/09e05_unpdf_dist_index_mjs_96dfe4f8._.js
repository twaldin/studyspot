...
"[project]/node_modules/.pnpm/unpdf@0.12.2/node_modules/unpdf/dist/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "createIsomorphicCanvasFactory": (()=>createIsomorphicCanvasFactory),
    ...
    "resolvePDFJSImports": (()=>resolvePDFJSImports)
});
let resolvedModule;
...
async function resolvePDFJSImports(pdfjsResolver, { force = false } = {}) {
    ...
    try {
        const { resolvePDFJS } = await __turbopack_context__.r("[project]/node_modules/.pnpm/unpdf@0.12.2/node_modules/unpdf/dist/pdfjs.mjs [app-route] (ecmascript, async loader)")(__turbopack_context__.i);
...
async function renderPageAsImage$1(data, pageNumber, options = {}) {
    ...
    const dataUrl = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ctx.canvas.toDataURL();
...
//# sourceMappingURL=09e05_unpdf_dist_index_mjs_96dfe4f8._.js.map
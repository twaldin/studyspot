 ...
 */
export function initializeStudyState(cards: Flashcard[], settings?: Partial<StudySettings>): StudyState {
...
export function updateStudySettings(
  ...
  if (needsReshuffle) {
    const currentCard = getCurrentCard(currentState);
    
    if (newSettings.mode === 'random') {
      shuffledCards = intelligentShuffle(
        originalCards, 
 ...
 */
export function navigateToNextCard(currentState: StudyState): StudyState {
 ...
 */
export function navigateToPreviousCard(currentState: StudyState): StudyState {
  const { progress, shuffledCards } = currentState;
 ...
 */
export function skipCurrentCard(currentState: StudyState): StudyState {
  // First flip the card, then navigate
  const flippedState = { ...currentState, isFlipped: true };
  return navigateToNextCard(flippedState);
}

/**
 * Flip the current card
 */
export function flipCard(currentState: StudyState): StudyState {
  return {
    ...currentState,
 ...
 */
export function getCurrentCard(studyState: StudyState): Flashcard | null {
 ...
 */
export function getCardDisplaySide(studyState: StudyState): 'side1' | 'side2' {
 ...
 */
export function initializeEditState(cards: Flashcard[]): EditState {
 ...
 */
export function updateCardInEditMode(
  editState: EditState,
  cardId: string,
 ...
 */
export function convertEditStateToSaveRequest(
  editState: EditState,
  setTitle: string,
 ...
 */
export function getProgressText(progress: StudyProgress): string {

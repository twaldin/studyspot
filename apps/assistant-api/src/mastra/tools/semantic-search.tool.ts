...
/**
 * Tool for agent-controlled semantic vector search
 * Allows the AI to define custom search queries and parameters for document retrieval
 */
export const semanticSearchTool = createTool({
  ...
  execute: async ({ context, runtimeContext }) => {
    ...
    try {
      ...
      // Perform vector search with custom parameters
